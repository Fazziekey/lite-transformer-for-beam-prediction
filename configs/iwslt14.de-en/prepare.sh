...
tgt=en
lang=de-en
prep=data/iwslt14.de-en/iwslt14.tokenized.de-en
orig=data/iwslt14.de-en/orig
tmp=$prep/tmp
...
TEXT=data/iwslt14.de-en/iwslt14.tokenized.de-en
fairseq-preprocess --source-lang de --target-lang en \
  --trainpref $TEXT/train --validpref $TEXT/valid --testpref $TEXT/test \
  --destdir data/binary/iwslt14.tokenized.de-en