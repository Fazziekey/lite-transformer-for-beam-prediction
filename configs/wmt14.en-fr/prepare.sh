...
# /mnt/lustre/share/git clone https://github.com/moses-smt/mosesdecoder.git

# echo 'Cloning Subword NMT repository (for BPE pre-processing)...'
# /mnt/lustre/share/git clone https://github.com/rsennrich/subword-nmt.git

# cd ..

SCRIPTS=preprocess_script/mosesdecoder/scripts
TOKENIZER=$SCRIPTS/tokenizer/tokenizer.perl
CLEAN=$SCRIPTS/training/clean-corpus-n.perl
NORM_PUNC=$SCRIPTS/tokenizer/normalize-punctuation.perl
REM_NON_PRINT_CHAR=$SCRIPTS/tokenizer/remove-non-printing-char.perl
BPEROOT=preprocess_script/subword-nmt
BPE_TOKENS=40000
...
TEXT=data/wmt14_en_fr/wmt14.tokenized.en-fr
fairseq-preprocess \
    --source-lang en --target-lang fr \
    --trainpref $TEXT/train --validpref $TEXT/valid --testpref $TEXT/test \
    --destdir data/binary/wmt14_en_fr --thresholdtgt 0 --thresholdsrc 0 \
